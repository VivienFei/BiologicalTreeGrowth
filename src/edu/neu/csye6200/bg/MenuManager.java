...
public class MenuManager implements ActionListener {
    ...
    /**
     * Constructor The menu manager ID is auto generated
     *
     ...
     * @param keyevent an accelerator key definition (i.e. KeyEvent.VK_N for
     * 'N'), or 0 if none defined
     * @param modifier an action event modifier (i.e. ActionEvent.ALT_MASK +
     * ActionEvent.SHIFT_MASK for Alt-shift)
